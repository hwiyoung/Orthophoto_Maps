...
def FRAM(frame_number, cols, rows, log_eo, io, project_path, video_id):
    ...
    # return video_id, path_orthophoto, frame_number, tm_eo, bbox_wkt
    return ortho_json


def INFE(infe_res, cols, rows, log_eo, io):
    # infe_res = [
    #     {
    #         "frame_number": 1,
    ...
    for i in range(len(infe_res)):
        ...
        # bbox_info = create_bbox_json(2, object_id, object_type, bbox_world)  # dictionary
...
#     log_eo, io, project_path, video_id = PATH(file_path="C:/DJI_0018.csv", video_id="525c671317165f77b0d31543634093abb")
#     # log_eo, io, project_path, video_id = PATH(file_path="C:/DJI_0030.csv", video_id="525c671317165f77b0d31543634093aba")
#
#     infe_res = [
#         {
#             "frame_number": 1,
...
#             # cols = 1920
#             # rows = 1080
#             bbox_total = INFE(infe_res, cols, rows, log_eo, io)
#
#             # frame_number = 1
#             ortho_json = FRAM(frame_number, cols, rows, log_eo, io, project_path, video_id)
#
#             SEND(bbox_total, ortho_json)
#
#     print("Hello")
